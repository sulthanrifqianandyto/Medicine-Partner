...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>login</title>
    <link rel="stylesheet" href="css/nicepage5.css" media="screen">
<link rel="stylesheet" href="css/login.css" media="screen">
    <script class="u-script" type="text/javascript" src="js/jquery5.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="js/nicepage5.js" defer=""></script>
  ...
  <meta data-intl-tel-input-cdn-path="intlTelInput5/"></head>
